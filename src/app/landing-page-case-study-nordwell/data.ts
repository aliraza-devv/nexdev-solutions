// ============================================================================
// CASE_STUDY — single source of truth for this page.
// Edit this object to swap in a real client. Every section below renders
// directly from these fields — nothing else in this route hardcodes copy.
// Image fields are plain strings describing the asset until real files exist;
// see ImagePlaceholder in CaseStudyClient.tsx for how they're rendered.
// ============================================================================
