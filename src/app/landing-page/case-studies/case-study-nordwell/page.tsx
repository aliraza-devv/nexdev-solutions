...
// CaseStudyTemplate.tsx instead. Everything below is derived from
// CASE_STUDY, so editing that one object keeps the SEO tags in sync.
...
const path = "/landing-page/case-studies/case-study-nordwell";
