// DISABLED - this is the old root page, kept for reference/restoration
// only. Renamed from page.js to page.legacy.js so Next.js no longer
// treats it as a route (it must be exactly "page.js"/"page.tsx" etc. to
// be picked up) - the real "/" now serves the page that used to live at
// /landing-page (see src/app/page.tsx). To bring this back: rename this
// file back to page.js and move src/app/page.tsx out of the way first,
// since both can't occupy the "/" route at once.
"use client";
