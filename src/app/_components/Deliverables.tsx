          ...
          >
            <div className="flex h-fit flex-col gap-6">
              <div className="flex items-center justify-between">
                <div className="text-[10px] font-bold tracking-widest text-[#5C45FD] uppercase">
              ...
              <div className="space-y-4">
                {bonuses.map((b, i) => (
                  ...
                  >
                    ...
                    <span className="text-lg font-semibold text-[#0A0A0E]">
                      {b}
                    </span>
                  </motion.div>
                ))}
              ...
              <div className="mt-2">
                <p className="text-[#6b7280] text-[12px] leading-relaxed max-w-[260px]">
                  Ensuring your new channel doesn&apos;t just launch, but
              ...
              <div className="mt-2 flex flex-col items-center gap-2">
                <Link href="/qualify" data-cursor="cta" className="w-full">
                  <motion.button
