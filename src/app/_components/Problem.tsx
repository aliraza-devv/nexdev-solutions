...
const problems = [
  {
    ...
    desc: "People land, look around, and leave. Yours can't be one of them.",
  },
  {
    title: "And your competitor gets the customer.",
    desc: "The buyer who almost chose you goes with whoever made it easy.",
  },
  {
    title: "You already know how this goes.",
    desc: "You want proof it'll work before you spend, not after.",
  },
  {
    title: "And waiting has a price.",
    desc: "Underperforming or not live yet, the cost is the same: business you should be winning.",
  },
  {
    title: "You get one shot at doing it right.",
    desc: "Done once beats done twice. That's why we start with strategy, not a template.",
  },
];
