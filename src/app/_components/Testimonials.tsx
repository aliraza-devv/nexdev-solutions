...
export default function Testimonials() {
  ...
  return (
    <section
      id="testimonials"
      className="relative bg-[#0A0A0E] pt-24 pb-12 lg:pt-40 lg:pb-12 overflow-hidden"
    >
              ...
              {videoTestimonials.map((v, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {!isMobile && isActive && v.videoUrl ? (
                      ...
                      <>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center z-20">
                          <div
                            className={`w-10 h-10 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center group-hover:bg-[#5C45FD] transition-all duration-300 ${isActive ? "bg-[#5C45FD]" : ""}`}
                          >
                    ...
                    <div
                      className={`absolute bottom-6 left-6 right-6 z-20 transition-opacity duration-300 ${isSelected ? "opacity-0" : "opacity-100"}`}
                    >
                      <div
      ...
      <AnimatePresence>
        {isMobile &&
          mobileVideoId !== null &&
          (() => {
            const videoItem = videoTestimonials.find(
              (v) => v.id === mobileVideoId,
            );
