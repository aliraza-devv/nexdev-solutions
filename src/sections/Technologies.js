    ...
    <div className="relative w-[100%]">
      ...
      <div className="flex flex-col lg:flex-row relative items-center md:items-start justify-center w-full gap-10">
        <div className="mt-10 p-10 flex flex-col justify-start items-start w-full lg:w-[40%]">
          <WordPullUp
            className="text-3xl lg-5:text-[35px] sm:text-4xl font-bold tracking-[-0.02em] text-[#f5f5f5] md:text-5xl md:leading-[5rem]"
        ...
        <div className="relative flex h-full sm-20:max-w-[100%] w-full lg:w-[50%] max-w-[38rem] items-center justify-center overflow-hidden rounded-lg px-6 sm:px-10 lg:px-20 pb-10 sm:pb-20 pt-6 sm:pt-8">
